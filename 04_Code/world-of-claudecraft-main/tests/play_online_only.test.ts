...
describe('/play uses the landing hero backdrop', () => {
  it('play.html defers the trailer exactly like index.html (poster paints first)', () => {
    ...
    expect(playHtml).toContain('data-trailer-src="/demons-whip-home-bg.mp4"');
    expect(playHtml).toContain('poster="/demons-whip-home-bg.png"');
    expect(playHtml).not.toContain('<source src="/demons-whip-home-bg.mp4"');
