...
describe('client HTML shell', () => {
  ...
  it('ships a looping cinematic backdrop with a poster fallback, lazy-loaded for perf', () => {
    ...
    expect(html).toContain('poster="/demons-whip-home-bg.png"');
    ...
    expect(html).toContain('data-trailer-src="/demons-whip-home-bg.mp4"');
    expect(html).toContain('preload="none"');
    expect(html).not.toContain('<source src="/demons-whip-home-bg.mp4"');
